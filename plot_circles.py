...
# HI (ABI), HB(ABI), SB(ABI)
# 1-2-3     4-5-6    7-8-9

# Need a separate xy file
...
x, y = np.genfromtxt('xy.dat', unpack=True)
...
# averages
# pH 3.0
ax1.scatter(x*1,   y, s=a1*4, c=COL1d)
...
# stdev
# pH 3.0
ax1.scatter(x*1,   y+0.3, s=a3*4, c='k', marker='_')
